;;; :FILE /home/sp/HG-Repos/emacs-load-files/naf-mode/mon-css-color.el;;; mon-css-color.el --- Highlight and edit CSS colors
;;; ==============================
;; -*- mode: EMACS-LISP; -*-
...
;;; ==============================
(defconst css-color:version "MON-0.04.1"
  "<Timestamp: #{2011-01-20T14:57:19-05:00Z}#{11034} - by MON>
...
`css-color-turn-on-in-buffer', `css-color:version'.\n▶▶▶"
  :link  '(custom-group-link 
           :tag "\n:CUSTOM-GROUP mon-css-color" 'mon-css-color)
  :link '(url-link 
          :tag "\n:EMACSWIKI-FILE (URL `http://www.emacswiki.org/emacs/mon-css-color.el')" 
          "http://www.emacswiki.org/emacs/mon-css-color.el")
  :link '(file-link 
          :tag "\n:FILE mon-css-color.el" 
          "mon-css-color.el")
  :group 'css)

(defgroup mon-css-color ()
  "Customization group for mon specific features provided by the `css-color' package.\n"
  :group 'css-color
  :group 'mon-base)
...
;;; ==============================
(defcustom *css-color:hex-chars* (concat (number-sequence 48 57) 
...
(defcustom *regexp-css-color-hex* "#\\([a-fA-F[:digit:]]\\{6\\}\\|[a-fA-F[:digit:]]\\{3\\}\\)"
...
;;; ==============================
(defcustom *regexp-css-color-hsl* 
...
;;; ==============================
(defcustom *regexp-css-color-rgb* 
...
;;; ==============================
(defcustom *css-color:html-colors*
  '(("AliceBlue" "#F0F8FF")
    ("AntiqueWhite" "#FAEBD7")
    ("Aqua" "#00FFFF")
    ("Aquamarine" "#7FFFD4")
...
;;;
(defcustom *regexp-css-color-html*
...
;;;   "\\)"))
;;; ==============================
(defcustom *regexp-css-color-color* 
  (concat  "\\(?:#"
...
(defvar *css-color:keywords*
  ...
  "*A list of regexps/font-lock rules propertizing css-color's in `css-color-mode'.\n
:SEE-ALSO `*regexp-css-color-hex*', `*regexp-css-color-hsl*',
`*regexp-css-color-rgb*', `*regexp-css-color-html*', `*regexp-css-color-color*',
`*css-color:keywords*', `*css-color:html-colors*', `*regexp-rgb-hex*',
`mon-help-css-color', `mon-help-color-functions', `mon-help-color-chart'.\n▶▶▶")
...
`mon-help-css-color', `mon-help-color-functions', `mon-help-color-chart'.\n▶▶▶"
  ...
  (unless font-lock-defaults
    (mon-format :w-fun #'error 
                :w-spec '(":MACRO `define-minor-mode' "
...
`mon-help-color-functions', `mon-help-color-chart'.\n▶▶▶"
  (cl-multiple-value-bind (r g b) (css-color:hex-to-rgb hex-color)
...
`mon-help-css-color', `mon-help-color-functions', `mon-help-color-chart'.\n▶▶▶"
  (cond ((not (string-match "^#?[a-fA-F[:digit:]]*$" hex-str->rgb))
         (mon-format :w-fun #'error
                     :w-spec '(":FUNCTION `css-color:hex-to-rgb' "
...
`css-color:hsl-to-rgb', `css-color:hsl-to-hex',
`mon-help-css-color', `mon-help-color-functions', `mon-help-color-chart'.\n▶▶▶"
  (cl-multiple-value-bind (r g b) (css-color:hex-to-rgb hex->hsv)
...
`css-color:hsl-to-rgb', `css-color:hsl-to-hex',
`mon-help-css-color', `mon-help-color-functions', `mon-help-color-chart'.\n▶▶▶"
  (cl-multiple-value-bind (r g b) (css-color:hsv-to-rgb h s v)
...
`mon-help-css-color', `mon-help-color-functions', `mon-help-color-chart'.\n▶▶▶"
  (cl-multiple-value-bind (h s v) hsv-color
...
`mon-help-color-chart'.\n▶▶▶"
  (cl-destructuring-bind ((cctpcr-beg . cycle-type) (cctpcr-end . cycle-type))
...
`mon-help-color-functions', `mon-help-color-chart'.\n▶▶▶"
  (interactive)
  (cl-destructuring-bind (ccct-beg ccct-end ccct-cycle-type ccct-color)
      (css-color:text-property-color-region)
    (and (or (= 0 (length ccct-color)) (null ccct-cycle-type))
         (mon-format :w-fun #'error 
                     :w-spec '(":FUNCTION `css-color:cycle-type' "
...
`mon-help-css-color', `mon-help-color-functions', `mon-help-color-chart'.\n▶▶▶"
  (interactive)
  (cl-multiple-value-bind (beg end cycle-type color)
...
`mon-help-css-color', `mon-help-color-functions', `mon-help-color-chart'.\n▶▶▶"
  ...
  (let ((cctp-psn (point))) ;; Used?
	...
	(let ((chars (concat `(37 ,@(number-sequence 49 57) 48 46))))
      ...
      (mon-message :msg-spec '(":FUNCTION `css-color:toggle-percentage' "
  ...
  (let* ((ccec-str (concat " Foreground: " fg-color ", Background: " bg-color " ")))
    ...
    (progn
      ...
      (mon-message :msg-fun 'minibuffer-message 
                   :msg-spec '(":FUNCTION `css-color:examine-color' "
                               " -- here are the colors:\n %s")
                   :msg-args ccec-str)
      (sit-for 2))))
...
`mon-help-color-chart'.\n▶▶▶"
  ...
  (unless
    ...
    (mon-message :w-spec '(":FUNCTION `css-color:run-tests' "
                           "-- all tests passed"))))
